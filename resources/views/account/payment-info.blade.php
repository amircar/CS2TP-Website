        ...
        <div class="accountbox">
            ...
            <div class="seperating-box">
                <div class="sidebar"><!-- sidebar -->
                    ...
                    <button class="active">Payment Information</button>
                ...
                <div class="paymentinfo-box" style="top:20%; left:35%;">
                    ...
                    <div class="paymentinfo-box2" style="top:20%; left:4%;">
                        <form><!-- Card Number -->
                            <input type="text2"
                                style="font-size:20px; width: 95%; padding-top: 20px; padding-bottom: 20px;"
                                id="account_cardnumber" name="account_cardnumber" placeholder="**** **** **** 1234">
                        </form>
                        <div class="paymentinfo-title" style="top:3%; left:10%; width:20%;">Card Number</div>

                        <!-- MM -->
                        <div class="paymentinfo-box2"
                            style="top:45%; left:0%; width: 100%; height:40%; display: flex; gap: 0px;">
                            <form>
                                <input type="text2"
                                    style="font-size:20px; width: 60%; padding-top: 20px; padding-bottom: 20px;"
                                    id="account_cardmonth" name="account_cardmonth" placeholder="05">
                            </form>
                            ...
                            <form>
                                <input type="text2"
                                    style="font-size:20px; width: 60%; padding-top: 20px; padding-bottom: 20px;"
                                    id="account_cardyear" name="account_cardyear" placeholder="28">
                            </form>
                            ...
                            <form>
                                <input type="text2"
                                    style="font-size:20px; width: 78%; padding-top: 20px; padding-bottom: 20px;"
                                    id="account_cardCVV" name="account_cardCVV" placeholder="709">
                            </form>
