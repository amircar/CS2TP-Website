...
<html lang="en-GB">
    ...
    <body>
        ...
        <main id="about-us-main">
            ...
            <h3 style="text-align: center; margin-top: 100px; position: absolute; color: white;">About Us</h3>
            <img src="assets/about-us-banner.jpg" alt="Clothes on a Hanger" class="image" width="100%" height="100%">
            </div>
            <!-- the small paragraph of text -->
           ...
           <!-- these are the three images --> <!-- TODO make three images rollover so text appears  -->
            ...
            <div id="section" style="justify-content: left; height: 450px;">
               ...
               <img src="assets/Team47-laptop-image.jpg" alt="Team47 Laptop Image" class="image" width="100%" height="100%">
               </div> 
            </div>
            ...
            <div id="section" style="justify-content: left; height: 450px;">
                ...
                <img src="assets/our-goal-about-us.jpg" alt="Team47 Our Goal" class="image" width="100%" height="100%">
                </div> 
