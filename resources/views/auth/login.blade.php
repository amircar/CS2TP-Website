                ...
                <div class="form-group remember-me">
                    <div class="form-group remember-me">
                        <div class="remember-me-container">
                            <input class="form-check-input custom-checkbox" type="checkbox" name="remember" id="remember-me-checkbox" {{ old('remember') ? 'checked' : '' }}>
                            <label class="form-check-label" for="remember-me-checkbox">{{ __('Remember Me') }}</label>
                        </div>
                    </div>
                </div>
